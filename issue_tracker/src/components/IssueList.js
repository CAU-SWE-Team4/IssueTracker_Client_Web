      ...
      <div className="flex mb-4">
        ...
        {searchCategory === 'state' ? (
          ...
          <div className="flex w-full">
            ...
            />
            <button
              className="text-white bg-gray-800 hover:bg-gray-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-2"
            ...
            {userRole === 'TESTER' && (
              <button
                className="text-white bg-green-600 hover:bg-green-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-2"
                onClick={openModal}
              >
                New issue
              </button>
